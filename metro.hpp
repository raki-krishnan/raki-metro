...
class Metro{
    ...
    void declare_stops(){
        ...
        Stop twinbrook("Twinbrook", size_t(1), twinbrook_adjacents);
        ...
        Stop north_bethesda("North Bethesda", size_t(1), north_bethesda_adjacents);
        ...
        Stop grovesnor("Grovesnor", size_t(1), grovesnor_adjacents);
        ...
        Stop medical_center("Medical Center", size_t(1), medical_center_adjacents);
        ...
        Stop bethesda("Bethesda", size_t(1), bethesda_adjacents);
        ...
        Stop friendship_heights("Friendship Heights", size_t(1), friendship_heights_adjacents);
        ...
        Stop tenleytown("Tenleytown", size_t(1), tenleytown_adjacents);
        ...
        Stop van_ness("Van Ness", size_t(1), van_ness_adjacents);
        ...
        Stop cleveland_park("Cleveland Park", size_t(1), cleveland_park_adjacents);
        ...
        Stop woodley_park("Woodley Park", size_t(1), woodley_park_adjacents);
        ...
        Stop dupont_circle("Dupont Circle", size_t(1), dupont_circle_adjacents);
        ...
        Stop farragut_north("Farragut North", size_t(1), farragut_north_adjacents);
        ...
        Stop judiciary_square("Judiciary Square", size_t(1), judiciary_square_adjacents);
        ...
        Stop union_station("Union Station", size_t(1), union_station_adjacents);
        ...
        Stop gallaudet("Gallaudet", size_t(1), gallaudet_adjacents);
        ...
        Stop rhode_island_ave("Rhode Island Ave", size_t(1), rhode_island_ave_adjacents);
        ...
        Stop brookland("Brookland", size_t(1), brookland_adjacents);
        ...
        Stop fort_totten("Fort Totten", size_t(1), fort_totten_adjacents);
        ...
        Stop takoma("Takoma", size_t(1), takoma_adjacents);
        ...
        Stop silver_spring("Silver Spring", size_t(1), silver_spring_adjacents);
        ...
        Stop forest_glen("Silver Spring", size_t(1), forest_glen_adjacents);
        ...
        Stop wheaton("Wheaton", size_t(1), wheaton_adjacents);
        ...
        Stop glenmont("Glenmont", size_t(1), glenmont_adjacents);
